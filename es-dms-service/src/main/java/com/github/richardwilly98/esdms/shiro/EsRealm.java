...
public class EsRealm extends AuthorizingRealm {
	...
	if (user == null) {
	    throw new AuthenticationException(String.format("Login name [%s] not found!", upToken.getUsername()));
	}
	...
	if (hash.equals(user.getHash())) {
	    ...
	    throw new AuthenticationException(String.format("Password not matching for login name [%s]", upToken.getUsername()));
	}
    }
