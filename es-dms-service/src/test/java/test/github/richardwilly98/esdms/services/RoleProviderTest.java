...
public class RoleProviderTest extends ProviderTestBase {
	...
	private String testCreateRole(String name, String description,
			Set<Permission> permissions, boolean disabled) throws Throwable {
	...
	public void testCreateRole() throws Throwable {
		...
		permissions.add(createPermission("annotation:read", "annotation:read",
				true));
		permissions.add(createPermission("annotation:write",
				"annotation:write", true));
		permissions.add(createPermission("comment:read", "comment:read", true));
		permissions
				.add(createPermission("comment:write", "comment:write", true));
		permissions.add(createPermission("content:todelete",
		...
		permissions
				.add(createPermission("profile:write", "profile:write", true));
		permissions
				.add(createPermission("content:write", "content:write", true));
		permissions.add(createPermission("content:add", "content:add", true));
		permissions.add(createPermission("content:remove", "content:remove",
				true));
		permissions.add(createPermission("profile:todelete",
				"profile:todelete", true));
		...
		permissions
				.add(createPermission("milestone:add", "milestone:add", true));
		permissions.add(createPermission("milestone:remove",
				"milestone:remove", true));
