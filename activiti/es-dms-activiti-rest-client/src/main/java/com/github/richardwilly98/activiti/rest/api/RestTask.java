 ...
 */
public class RestTask extends RestItemBase {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("id", getId()).add("name", getName()).add("description", getDescription())
                .add("url", getUrl()).add("owner", owner).add("assignee", assignee).add("delegationState", delegationState)
                .add("createTime", createTime).add("dueDate", dueDate).add("priority", priority).add("suspended", suspended)
                .add("taskDefinitionKey", taskDefinitionKey).add("parentTaskId", parentTaskId).add("parentTaskUrl", parentTaskUrl)
                .add("executionId", executionId).add("executionUrl", executionUrl).add("processInstanceId", processInstanceId)
                .add("processInstanceUrl", processInstanceUrl).add("processDefinitionId", processDefinitionId)
                .add("processDefinitionUrl", processDefinitionUrl).add("variables", variables).toString();
    }
