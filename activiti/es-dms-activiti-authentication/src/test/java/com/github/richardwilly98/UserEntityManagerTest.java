...
public class UserEntityManagerTest extends SpringActivitiTestCase {
	...
	private static final Logger log = Logger
			.getLogger(UserEntityManagerTest.class);

	public void testCheckPassword() {
		log.debug("*** checkPassword ***");
		boolean isAuthenticated = identityService.checkPassword("kermit",
				"kermit");
	...
	public void testFindUserById() {
		...
		UserQuery query = identityService.createUserQuery().userId(
				"kermit-" + System.currentTimeMillis());
	...
	public void testFindUserByEmail() {
		...
		UserQuery query = identityService.createUserQuery().userEmail(
				"kermit-" + System.currentTimeMillis());
		assertTrue(query.list().size() == 0);
	...
	public void testFindUserByLastName() {
		...
		UserQuery query = identityService.createUserQuery().userLastName(
				"kermit-" + System.currentTimeMillis());
		assertTrue(query.list().size() == 0);
